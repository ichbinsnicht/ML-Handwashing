...
# data source: https://www.aeaweb.org/articles?id=10.1257/app.20190568

mydata = pd.read_csv("data/AnalysisReady_Full Dataset.csv")

# Create reduced CSV file for computational convenience
# CONTINUE HERE
